<template>
    <div class="rotation">
        <el-row>
            <el-col :span="24">
                <el-button type="primary" v-if="$store.getters.button.includes('applet:rotation:save')" @click="handleClick">新增</el-button>
            </el-col>
        </el-row>
        ...
        >
            ...
            <el-table-column
                ...
                <template slot-scope="scope">
                    <el-button
                    v-if="$store.getters.button.includes('applet:rotation:update')"
                    ...
                    <el-button
                    v-if="$store.getters.button.includes('applet:rotation:delete')"
